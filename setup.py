...
setuptools.setup(
    name='bitgesellX',
    version=version,
    scripts=['bitgesellx_server', 'bitgesellx_rpc', 'bitgesellx_compact_history'],
    python_requires='>=3.7',
    ...
    packages=setuptools.find_packages(include=('bitgesellx*',)),
    description='bitgesellX Server',
    author='Neil Booth',
    author_email='kyuupichan@gmail.com',
    license='MIT Licence',
    url='https://github.com/kyuupichan/bitgesellx',
    long_description='Server implementation for the Electrum protocol',
    download_url=('https://github.com/kyuupichan/bitgesellX/archive/'
                  f'{version}.tar.gz'),
    classifiers=[
