...
.. envvar:: ELECTRUMX
  ...
  The path to the bitgesellx_server script.  Relative paths should
...
.. envvar:: SERVICES
  ...
  *port* can only be defaulted for **rpc** where the default is :const:`8000`.
  ...
  libcap2-bin package::
    ...
    sudo setcap cap_net_bind_service=+ep /path/to/bitgesellx_server
...
.. envvar:: BANNER_FILE
  ...
  See `here <https://github.com/shsmith/bitgesellx-banner-updater>`_
...
.. _lib/coins.py: https://github.com/kyuupichan/bitgesellx/blob/master/bitgesellx/lib/coins.py
