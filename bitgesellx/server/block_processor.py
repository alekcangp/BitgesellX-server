...
from bitgesellx.lib.hash import hash_to_hex_str, HASHX_LEN
from bitgesellx.lib.script import is_unspendable_legacy, is_unspendable_genesis
from bitgesellx.lib.util import (
    chunks, class_logger, pack_le_uint32, pack_le_uint64, unpack_le_uint64
)
from bitgesellx.server.db import FlushData
...
class BlockProcessor(object):
    ...
    async def _first_caught_up(self):
        ...
        await self.flush(True)
        if first_sync:
            self.logger.info(f'{bitgesellx.version} synced to '
