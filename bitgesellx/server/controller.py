...
import bitgesellx
from bitgesellx.lib.server_base import ServerBase
from bitgesellx.lib.util import version_string
from bitgesellx.server.db import DB
from bitgesellx.server.mempool import MemPool, MemPoolAPI
from bitgesellx.server.session import SessionManager
...
class Controller(ServerBase):
    ...
    async def serve(self, shutdown_event):
        ...
        self.logger.info(f'software version: {bitgesellx.version}')
