...
on.  This is best done using the :file:`bitgesellx_rpc` script
provided.

The general form of invocation is::

  bitgesellx_rpc [-p PORT] <command> [arg1 [arg2...]]
...
"real name" as it used to advertise itself on IRC::
  ...
  $ bitgesellx_rpc add_peer "ecdsa.net v1.0 s110 t"
...
Example::
  ...
  $ bitgesellx_rpc disconnect 209.59.102 34 2
  [
...
For example::
  ...
  $ bitgesellx_rpc query --limit 5 76a91462e907b15cbf27d5425399ebf6f0fb50ebb88f1888ac
